    ...
    <div className='row d-flex flex-column justify-content-center align-items-center m-0 p-0' style={{ height: '100vh' }}>
      <form className='col-4 d-flex flex-column justify-content-center gap-3 border p-5 rounded shadow'>
        ...
        <div class="form-group">
          <label for="inputEmail4" className='mb-2'>First Name</label>
          <input type="text" class="form-control shadow-none" id="inputEmail4" placeholder="First Name" />
        </div>
        <div class="form-group">
          <label for="inputEmail4" className='mb-2'>Last Name</label>
          <input type="text" class="form-control shadow-none" id="inputEmail4" placeholder="Last Name" />
        </div>
        <div class="form-group">
        ...
        <div className='d-flex justify-content-center justify-content-around align-items-center'>
          <button type="submit" class="btn btn-dark border-0 shadow-none px-4">Register</button>
        </div>
        <div className='d-flex justify-content-center justify-content-around align-items-center'>
